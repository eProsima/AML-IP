...
# DESCRIPTION:
# This script allow to automatically update project elements autogenerated.
# This includes:
# - to re-autogenerate those files that have been autogenerated
# - to re-generate those files that depends on hard links from other documents

# DEPENDENCIES:
# This scrip depends on dev-utils to be located in ../dev-utils
