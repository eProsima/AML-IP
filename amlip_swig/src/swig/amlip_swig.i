...
%module(directors="1", threads="1", moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('amlip_cppd-@amlip_cpp_VERSION_MAJOR@.@amlip_cpp_VERSION_MINOR@.dll')\nif __package__ or '.' in __name__:\n from . import _amlip_swig\nelse:\n import _amlip_swig") amlip_swig
