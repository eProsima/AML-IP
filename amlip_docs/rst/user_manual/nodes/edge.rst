...
The thread calling this method will wait until the whole process has finished and the *Inference* has arrived from the :ref:`user_manual_nodes_inference` or :ref:`user_manual_nodes_async_inference` in charge of this data.
