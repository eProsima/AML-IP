...
def show_images(path1, path2):
    ...
    horizontally = np.concatenate((image_1, image_2), axis=1)
    cv2.imshow("Image - Inference image", horizontally)
    cv2.waitKey(0)
...
def main():
    ...
    image_path = current_path.split("amlip_tensorflow_inference_demo",-1)[0]+"amlip_tensorflow_inference_demo/resource/tensorflow/models/research/object_detection/test_images/dog.jpg"
