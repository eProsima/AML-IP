        ...
        char** argv)
{
    ...
    logUser(AMLIPCPP_MANUAL_TEST, "Starting Manual Test Main Node execution. Creating Node...");

    {
        ...
        logUser(AMLIPCPP_MANUAL_TEST, "Solution received. Deseralizing to string...");
